...
// =====================================================================================
//
//       Filename:  ringcache-sync_test.go
//
...
func TestSyncPushBackAndQuery(t *testing.T) {
...
func TestSyncSkipPushBack(t *testing.T) {
	check := func(statement bool, msg string) {
		var line int
		_, _, line, _ = runtime.Caller(1)
		if statement == false {
...
func BenchmarkRingCacheSync(b *testing.B) {
	b.ResetTimer()
	b.ReportAllocs()
